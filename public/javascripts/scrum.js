$(function(){
  ...
  $(".doingBox").droppable({
     ...
     drop:function(event,ui){
       ...
       $.ajax({
         method:"POST",
         url:"http://soylatte.kr:3000/changeSetPlace",
   ...
   $(".doneBox").droppable({
    ...
    $(".addBtn").click(function(){
      window.location = "http://soylatte.kr:3000/scrumAdd"
    });
  // $(".addBtn").click(function(){
  //   console.log("a")
  ...
  $(".scrum").draggable({
    ...
    window.onload = function sessionIdCheck(){
      $.ajax({
        method:"POST",
        url:"http://soylatte.kr:3000/sessionIdCheck",
        success:function(data){
          if(data == "1"){
            ...
            $.ajax({
              method:"POST",
              url:"http://soylatte.kr:3000/scrumList",
              success:function(list){
                ...
                if(list == "1"){
                  ...
                  $(".BtnBox").click(function memoClick(){
                    ...
                    $.ajax({
                      method:"POST",
                      url:"http://soylatte.kr:3000/scrumFix",
                      data:{"setNum":setNum[0]},
                      success:function(data){
                          if(data == "0"){
                            window.location = "http://soylatte.kr:3000/fix"
                          }
                      }
                    })
                  });
    ...
    $(".scrumLogout").click(function(){
      $.ajax({
        method:"POST",
        url:"http://soylatte.kr:3000/logout",
        success:function(data){
          if(data == "1"){
            window.location = "login.html"
          }
